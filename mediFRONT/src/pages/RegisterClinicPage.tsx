  ...
  return (
    <div className="flex min-h-[calc(100vh-80px)] bg-white">
      ...
      <div className="hidden lg:flex flex-1 bg-[#FDF9F3] relative items-center justify-center overflow-hidden border-r border-[#1C365C]/5">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_20%_80%,#5A9BD4_0%,transparent_50%)] opacity-10" />
        <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_20%,#E6CBB8_0%,transparent_50%)] opacity-10" />
        ...
        >
          <div className="w-16 h-16 bg-white rounded-3xl flex items-center justify-center shadow-sm border border-[#1C365C]/5 mb-8">
            <Building2 className="w-8 h-8 text-[#E6CBB8]" />
          </div>
          <h1 className="text-4xl lg:text-5xl font-bold text-[#1C365C] tracking-tight leading-[1.1] mb-6">
            Administra tu clínica<br/>de forma inteligente.
          </h1>
          <p className="text-xl text-[#1C365C]/60 font-medium">
            Centraliza la gestión de tus especialistas, horarios y pacientes en una sola plataforma.
          </p>
        </motion.div>
      </div>
      ...
      <div className="flex-[1.2] flex flex-col justify-center p-6 sm:p-12 relative overflow-y-auto custom-scrollbar">
        ...
        >
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-bold text-[#1C365C] tracking-tight mb-2">Registro de Clínica</h2>
            <p className="text-[#1C365C]/60 font-medium">Registra tu centro médico y empodera a tu equipo.</p>
          </div>
