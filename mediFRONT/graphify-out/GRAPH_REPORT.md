...
## Corpus Check
- 86 files · ~235,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 284 nodes · 537 edges · 38 communities (22 shown, 16 thin omitted)
...
- [[_COMMUNITY_Location Store|Location Store]]
- [[_COMMUNITY_Selected Profile Store|Selected Profile Store]]
...
- [[_COMMUNITY_Public Profile Progress|Public Profile Progress]]
...
3. `ProfileService` - 13 edges
4. `Doctor` - 13 edges
5. `useProfileStore` - 13 edges
6. `useConfigStore` - 13 edges
7. `useAuthStore` - 13 edges
8. `delay()` - 12 edges
...
Cohesion: 0.1
Nodes (24): AvailabilityPreview(), AvailabilityPreviewProps, SearchResultCardProps, Sidebar(), CareLocationsTabs(), DoctorAvailabilityPanel(), DoctorExperienceCard(), GalleryGrid() (+16 more)
...
Cohesion: 0.12
Nodes (16): SearchResultCard(), DefaultIcon, SearchMap(), SearchMapProps, HomePage(), ProfilePage(), SearchPage(), LocationState (+8 more)

### Community 4 - "User Authentication & Registration"
Cohesion: 0.15
Nodes (7): RegisterClinicForm(), RegisterDoctorForm(), RegisterPatientForm(), Navbar(), LoginPage(), AuthState, useAuthStore

### Community 5 - "System UI & State Management"
Cohesion: 0.26
Nodes (12): EmptyState(), LoadingState(), SaveToast(), ConfigPage(), useConfigStore, AppointmentRulesTab(), AvailabilityBlocksTab(), PendingRequestsTab() (+4 more)

### Community 6 - "Professional Configuration & Mock Data"
Cohesion: 0.16
Nodes (17): System States, Availability Blocks Tab, Pending Requests Tab, Weekly Schedule Tab, Config Store, ConfigState, AppointmentRules, AvailabilityBlock (+9 more)
...
### Community 15 - "Homepage Branding"
Cohesion: 0.67
...
## Knowledge Gaps
- **38 isolated node(s):** `mockIdentity`, `mockContact`, `mockEducation`, `mockExperience`, `ApptStatus` (+33 more)
...
- **Why does `Button` connect `System UI & State Management` to `Doctor & Patient Profiles`, `Professional Profile Management`, `Search & Location Services`, `User Authentication & Registration`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `ProfileService` connect `Profile Logic & Services` to `Professional Profile Management`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `useAgendaStore` connect `Professional Agenda & Appointments` to `System UI & State Management`?**
...
- **Should `Search & Location Services` be split into smaller, more focused modules?**
